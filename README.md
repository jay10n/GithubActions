[![Run App JaytonSchmeeckle](https://github.com/jay10n/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/jay10n/GithubActions/actions/workflows/run-app.yaml)
